...
import {
  ...
  ISubscriptionPayment, ISlipSubscriptionDB, IGappShopPaymentData
} from './type-gapp-slip';
...
export namespace GappBiz {
  ...
  // $REPLY
  export type ReplyTemplate = IDBReplyId & IReplyTemplate & IReplyData &
    IApiCompanyParams &
    IDBCompanyActivityLog;
  export type ListReplyTemplate = IDBReplyId & IReplyTemplate & IReplyData &
    IApiCompanyParams &
    IDBCompanyActivityLog;

  // $REPLY LINE
  // * Body Create Reply Template Line
  export type CreateReplyTemplateLine = IReplyTemplate & IReplyDataLine & IApiCompanyParams
  ...
  export type ListReplyTemplateLine = ReplyTemplateLine
  ...
  export type ConnectRichMenuList =
    IRichMenuId
    & IRichMenuLineId
    & IRichName
    & IRichTemplate
  ...
  export type MemberFromLine = IMemberFromLine & IMemberId
}
...
export namespace GappSlip {
  ...
  export type CreateShop = IGappShopEntity & IGappShopPaymentData & IGappUserEntity & IDBLogTime;
  export type Shop = IGappShopEntity & IGappUserEntity & IDBGappShopImmu & IDBLogTime;
  export type ShopWithPayment = IGappShopPaymentData & IGappShopEntity & IGappUserEntity & IDBGappShopImmu & IDBLogTime;
