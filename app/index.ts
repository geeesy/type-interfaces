...
import {IPackageBusinessData, IPackageCount} from "./type-package";
...
export namespace GappBusiness {
  ...
  export type PackageBusiness = IPackageBusinessData & IPackageCount
  export type Package = IPackageCount
}
