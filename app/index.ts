...
import { IApiCompanyCreateUserParams, IApiCompanyParams, IApiSupplierParams, ICertificate, ICompanyByGapp, ICompanyCreateSalesRep, ICompanyEntity, ICompanyEntityImmu, ICompanyPortfolio, ICompanyPortfolioImmu, ICompanyPrivateEntity, ICompanySalesRep, ICompanyUserData, ICompanyUserIdentity, ICompanyUserPrivateData, IDBCompanyEntity, IDBCompanyPortEntity, IDBCompanyUserData, IDocument, IPublishParams, ISettingCreatePriceGroup, ISettingCreatePriceList, ISettingDoc, ISettingPriceGroup, ISettingPriceList } from './type-company'
...
export namespace GappBusiness {
  ...
  export type Company = ICompanyEntity & ICompanyEntityImmu & ICompanyPrivateEntity & IDBCompanyEntity & IDBCompanyPortEntity & ICompanyByGapp & IDBLogTime
...
export namespace GappBiz {
  ...
  export type SupplierDocument = IDocument
  export type SupplierCertificate = ICertificate
