...
import {
    ...
    IListReturnOrder,
    ILogOrder,
    IOrderAccountingOnly, IOrderAffiliateData,
    IOrderCustomerData,
...
import {
    ...
    ICampaignData,
    ICampaignDataImmu,
    ICampaignDateType, IConversionDataImmu, IDBPartner, IListPartnerData,
...
export namespace GappBiz {
    ...
    export type Campaign =
        ...
        & IDBCompanyActivityLog
        & ICampaignCount;
    export type CreatePartner = IPartnerData & IPartnerDataImmu & IDBCompanyActivityLog;
    export type ListPartner = IListPartnerData & IPartnerDataImmu & IDBPartner & IDBCompanyActivityLog;
    export type Partner = IPartnerData & IPartnerDataImmu & IDBPartner & IDBCompanyActivityLog;
...
export namespace GappApi {
    export type ConfirmOrderLink = IOrderLinkDataOnConfirm & IOrderAffiliateData &
        IOrderCustomerData &
        IOrderCustomerDataImmu &
        IOrderAccountingOnly &
        IOrderLinkImmuDataOnConfirm &
